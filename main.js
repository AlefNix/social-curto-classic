...
btncorbasepreto.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#E9C8BF");
  document.getElementById('CB').style.backgroundColor = "#E9C8BF";
});
//base azul
const btncorbaseazul = document.getElementById('bluebase');
btncorbaseazul.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#B8C5C5");
  document.getElementById('CB').style.backgroundColor = "#B8C5C5";
});    
//base vermelha
const btncorbasevermelha = document.getElementById('redbase');
btncorbasevermelha.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#B6AD90");
  document.getElementById('CB').style.backgroundColor = "#B6AD90";
});  
//base amarela
const btncorbaseamarela = document.getElementById('yellowbase');
btncorbaseamarela.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#B5D1B6");
  document.getElementById('CB').style.backgroundColor = "#B5D1B6";
});  
//base verde
const btncorbaseverde = document.getElementById('greenbase');
btncorbaseverde.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#7B95AE");
  document.getElementById('CB').style.backgroundColor = "#7B95AE";
});  

document.getElementById('base1').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#495657");
  document.getElementById('CB').style.backgroundColor = "#495657";
});  
document.getElementById('base2').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#182950");
  document.getElementById('CB').style.backgroundColor = "#182950";
});  
document.getElementById('base3').addEventListener('click', function(e){
  ...
  btncorbotoespreto.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#E9C8BF";
    document.getElementById('BT').style.backgroundColor = "#E9C8BF";
  });
  //botoes azul
  const btncorbotoesazul = document.getElementById('bluebase1');
  btncorbotoesazul.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#B8C5C5";
    document.getElementById('BT').style.backgroundColor = "#B8C5C5";
  });    
  //botoes vermelha
  const btncorbotoesvermelha = document.getElementById('redbase1');
  btncorbotoesvermelha.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#B6AD90";
    document.getElementById('BT').style.backgroundColor = "#B6AD90";
  });  
  //botoes amarela
  const btncorbotoesamarela = document.getElementById('yellowbase1');
  btncorbotoesamarela.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#B5D1B6";
    document.getElementById('BT').style.backgroundColor = "#B5D1B6";
  });  
  //botoes verde
  const btncorbotoesverde = document.getElementById('greenbase1');
  btncorbotoesverde.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#7B95AE";
    document.getElementById('BT').style.backgroundColor = "#7B95AE";
  });  

  document.getElementById('base11').addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#495657";
    document.getElementById('BT').style.backgroundColor = "#495657";
  });  
  document.getElementById('base21').addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#182950";
    document.getElementById('BT').style.backgroundColor = "#182950";
  });  
  ...
  btncorgolaEpreto.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#E9C8BF";
    document.getElementById('golaEE').style.fill = "#E9C8BF";
    document.getElementById('ge').style.backgroundColor = "#E9C8BF";
  });
  //Gola exterior azul
  const btncorgolaEazul = document.getElementById('bluebase2');
  btncorgolaEazul.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#B8C5C5";
    document.getElementById('golaEE').style.fill = "#B8C5C5";
    document.getElementById('ge').style.backgroundColor = "#B8C5C5";
  });    
  ...
  btncorgolaEvermelha.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#B6AD90";
    document.getElementById('golaEE').style.fill = "#B6AD90";
    document.getElementById('ge').style.backgroundColor = "#B6AD90";
  });  
  ...
  btncorgolaEamarela.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#B5D1B6";
    document.getElementById('golaEE').style.fill = "#B5D1B6";
    document.getElementById('ge').style.backgroundColor = "#B5D1B6";
  });  
  //Gola exterior verde
  const btncorgolaEverde = document.getElementById('greenbase2');
  btncorgolaEverde.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#7B95AE";
    document.getElementById('golaEE').style.fill = "#7B95AE";
    document.getElementById('ge').style.backgroundColor = "#7B95AE";
  });  
  document.getElementById('base12').addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#495657";
    document.getElementById('golaEE').style.fill = "#495657";
    document.getElementById('ge').style.backgroundColor = "#495657";
  });  
  document.getElementById('base22').addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#182950";
    document.getElementById('golaEE').style.fill = "#182950";
    document.getElementById('ge').style.backgroundColor = "#182950";
  });  
  ...
  btncorgolaIpreto.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#E9C8BF";
    document.getElementById('gi').style.backgroundColor = "#E9C8BF";
  });
  //Gola interior azul
  const btncorgolaIazul = document.getElementById('bluebase3');
  btncorgolaIazul.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#B8C5C5";
    document.getElementById('gi').style.backgroundColor = "#B8C5C5";
  });    
  ...
  btncorgolaIvermelha.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#B6AD90";
    document.getElementById('gi').style.backgroundColor = "#B6AD90";
  });  
  ...
  btncorgolaIamarela.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#B5D1B6";
    document.getElementById('gi').style.backgroundColor = "#B5D1B6";
  });  
  //Gola interior verde
  const btncorgolaIverde = document.getElementById('greenbase3');
  btncorgolaIverde.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#7B95AE";
    document.getElementById('gi').style.backgroundColor = "#7B95AE";
  });  
  document.getElementById('base13').addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#495657";
    document.getElementById('gi').style.backgroundColor = "#495657";
  });  
  document.getElementById('base23').addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#182950";
    document.getElementById('gi').style.backgroundColor = "#182950";
  });  
...
//punho branca
  ...
  btncorpunhopreto.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#E9C8BF";
    document.getElementById('punho1').style.fill = "#E9C8BF";
    document.getElementById('PU').style.backgroundColor = "#E9C8BF";
  });
  //punho azul
  const btncorpunhoazul = document.getElementById('bluebase4');
  btncorpunhoazul.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#B8C5C5";
    document.getElementById('punho1').style.fill = "#B8C5C5";
    document.getElementById('PU').style.backgroundColor = "#B8C5C5";
  });    
  //punho vermelha
  const btncorpunhovermelha = document.getElementById('redbase4');
  btncorpunhovermelha.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#B6AD90";
    document.getElementById('punho1').style.fill = "#B6AD90";
    document.getElementById('PU').style.backgroundColor = "#B6AD90";
  });  
  //punho amarela
  const btncorpunhoamarela = document.getElementById('yellowbase4');
  btncorpunhoamarela.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#B5D1B6";
    document.getElementById('punho1').style.fill = "#B5D1B6";
    document.getElementById('PU').style.backgroundColor = "#B5D1B6";
  });  
  //punho verde
  const btncorpunhoverde = document.getElementById('greenbase4');
  btncorpunhoverde.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#7B95AE";
    document.getElementById('punho1').style.fill = "#7B95AE";
    document.getElementById('PU').style.backgroundColor = "#7B95AE";
  });
  ...
  btncorvistaEpreto.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#E9C8BF";
    document.getElementById('VE').style.backgroundColor = "#E9C8BF";
  });
  //vistaE azul
  const btncorvistaEazul = document.getElementById('bluebase5');
  btncorvistaEazul.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#B8C5C5";
    document.getElementById('VE').style.backgroundColor = "#B8C5C5";
  });    
  //vistaE vermelha
  const btncorvistaEvermelha = document.getElementById('redbase5');
  btncorvistaEvermelha.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#B6AD90";
    document.getElementById('VE').style.backgroundColor = "#B6AD90";
  });  
  //vistaE amarela
  const btncorvistaEamarela = document.getElementById('yellowbase5');
  btncorvistaEamarela.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#B5D1B6";
    document.getElementById('VE').style.backgroundColor = "#B5D1B6";
  });  
  //vistaE verde
  const btncorvistaEverde = document.getElementById('greenbase5');
  btncorvistaEverde.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#7B95AE";
    document.getElementById('VE').style.backgroundColor = "#7B95AE";
  });

  document.getElementById('base15').addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#495657";
    document.getElementById('VE').style.backgroundColor = "##495657";
  });
  document.getElementById('base25').addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#182950";
    document.getElementById('VE').style.backgroundColor = "#182950";
  });
  ...
  btncorvistaDpreto.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#E9C8BF";
    document.getElementById('VD').style.backgroundColor = "#E9C8BF";
  });
  //vistaD azul
  const btncorvistaDazul = document.getElementById('bluebase6');
  btncorvistaDazul.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#B8C5C5";
    document.getElementById('VD').style.backgroundColor = "#B8C5C5";
  });    
  //vistaD vermelha
  const btncorvistaDvermelha = document.getElementById('redbase6');
  btncorvistaDvermelha.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#B6AD90";
    document.getElementById('VD').style.backgroundColor = "#B6AD90";
  });  
  //vistaD amarela
  const btncorvistaDamarela = document.getElementById('yellowbase6');
  btncorvistaDamarela.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#B5D1B6";
    document.getElementById('VD').style.backgroundColor = "#B5D1B6";
  });  
  //vistaD verde
  const btncorvistaDverde = document.getElementById('greenbase6');
  btncorvistaDverde.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#7B95AE";
    document.getElementById('VD').style.backgroundColor = "#7B95AE";
  });
  ...
  btncorbolsoFpreto.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#E9C8BF";
    document.getElementById('BSF').style.backgroundColor = "#E9C8BF";
  });
  //Bolso Faixa azul
  const btncorbolsoFazul = document.getElementById('bluebase7');
  btncorbolsoFazul.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#B8C5C5";
    document.getElementById('BSF').style.backgroundColor = "#B8C5C5";
  });    
  ...
  btncorbolsoFvermelha.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#B6AD90";
    document.getElementById('BSF').style.backgroundColor = "#B6AD90";
  });  
  //Bolso Faixa amarela
  const btncorbolsoFamarela = document.getElementById('yellowbase7');
  btncorbolsoFamarela.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#B5D1B6";
    document.getElementById('BSF').style.backgroundColor = "#B5D1B6";
  });  
  //Bolso Faixa verde
  const btncorbolsoFverde = document.getElementById('greenbase7');
  btncorbolsoFverde.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#7B95AE";
    document.getElementById('BSF').style.backgroundColor = "#7B95AE";
  });
  ...
  btncorbolsoBpreto.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#E9C8BF";
    document.getElementById('BB').style.backgroundColor = "#E9C8BF";
  });
  //Bolso Faixa azul
  const btncorbolsoBazul = document.getElementById('bluebase8');
  btncorbolsoBazul.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#B8C5C5";
    document.getElementById('BB').style.backgroundColor = "#B8C5C5";
  });    
  //Bolso Faixa vermelha
  const btncorbolsoBvermelha = document.getElementById('redbase8');
  btncorbolsoBvermelha.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#B6AD90";
    document.getElementById('BB').style.backgroundColor = "#B6AD90";
  });  
  //Bolso Faixa amarela
  const btncorbolsoBamarela = document.getElementById('yellowbase8');
  btncorbolsoBamarela.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#B5D1B6";
    document.getElementById('BB').style.backgroundColor = "#B5D1B6";
  });  
  //Bolso Faixa verde
  const btncorbolsoBverde = document.getElementById('greenbase8');
  btncorbolsoBverde.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#7B95AE";
    document.getElementById('BB').style.backgroundColor = "#7B95AE";
  });
